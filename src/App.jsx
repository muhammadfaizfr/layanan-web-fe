...
function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-between">
                      <div>
                        ...
                        <p className="text-on-surface-variant max-w-sm leading-relaxed">
                          Nikmati panorama kawah gunung berapi dengan danau berwarna hijau zamrud yang menakjubkan. Dikelilingi tebing megah.
                        </p>
                      </div>
                    </div>
                    <img 
      ...
      case 'panduan-pendakian':
        return (
          <PanduanPendakian navigate={setCurrentPage} openModal={openModal} />
        )
      ...
      case 'admin-ringkasan':
        return (
          <RingkasanAdmin navigate={setCurrentPage} />
        )
      case 'admin-manajemen-tiket':
        return (
      ...
      case 'admin-tiket-berhasil':
        return (
          <TiketBerhasilAdmin navigate={setCurrentPage} />
        )
      case 'admin-tiket-gagal':
        return (
          <TiketGagalAdmin navigate={setCurrentPage} />
        )
      case 'kontak':
        return (
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#f9f9f7]/80 backdrop-blur-md shadow-[0_4px_40px_0_rgba(22,52,34,0.04)]">
        <div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto w-full">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button onClick={() => setCurrentPage('kontak')} className={`text-sm tracking-wide font-medium pb-1 transition-colors duration-300 ${currentPage === 'kontak' ? 'text-[#163422] border-b-2 border-[#163422]' : 'text-[#695d47] hover:text-[#163422]'}`}>Kontak</button>
            <button onClick={() => setCurrentPage('panduan-pendakian')} className={`text-sm tracking-wide font-medium pb-1 transition-colors duration-300 ${currentPage === 'panduan-pendakian' ? 'text-[#163422] border-b-2 border-[#163422]' : 'text-[#695d47] hover:text-[#163422]'}`}>Panduan Pendakian</button>
          </div>
      ...
      <footer className="w-full border-t border-[#163422]/5 bg-[#f4f4f2] py-8">
        <div className="text-center w-full max-w-7xl mx-auto px-8">
          <p className="text-sm text-[#695d47] opacity-80">© 2026 Gunung Galunggung. All rights reserved.</p>
        </div>
      </footer>
